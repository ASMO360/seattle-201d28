...
//this stupid error causes no problems but wont go away and it upsets me
console.log('name', name);

var height = prompt('So my first question for you, ' + name + ', is am I 6\'2"? (y or n)').toUpperCase();
...
while(i > 0) {
  var guessedNum = parseInt(prompt('Guess what number I am thinking of between 1 and 10.'));
